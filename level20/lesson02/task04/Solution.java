...
public class Solution {
    public static void main(String[] args) {
        ...
        try {
            ...
            File your_file_name = File.createTempFile("D:\\file.txt", null);
            ...
            if (classWithStatic == loadedObject) {
    ...
    public static class ClassWithStatic {
        ...
        public void save(OutputStream outputStream) throws Exception {
            ...
            String hasString = staticString != null ? "yes" : "no";
            printWriter.println(hasString);
            if (hasString.equals("yes"))
        ...
        public void load(InputStream inputStream) throws Exception {
            ...
            String hasString = reader.readLine();
            if (hasString.equals("yes"))
