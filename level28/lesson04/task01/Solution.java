...
public class Solution {
    ...
    public static class AmigoThreadFactory implements ThreadFactory {
        ...
        private static AtomicInteger numberOfFactory = new AtomicInteger(0);
        private AtomicInteger numberOfThread = new AtomicInteger(0);

        public AmigoThreadFactory()
        {
            numberOfFactory.incrementAndGet();
        }
        ...
        public Thread newThread(Runnable r)
        {
            ...
            thread.setName(thread.getThreadGroup().getName() + "-pool-" + numberOfFactory + "-thread-" + numberOfThread);
            return thread;
        }
    }
}
